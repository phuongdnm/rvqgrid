...
computational costs. Neural Audio Codecs (NACs) offer an efficient alternative by operating in compressed
latent spaces. However, the existing codec-based method aggregates per-layer Residual Vector Quantization
